...
async def lifespan(app: FastAPI):
    ...
    from code.models.symptom_analyzer import BERTSymptomAnalyzer
    from code.models.risk_classifier import RiskClassifier
    from code.models.doctor_recommender import DoctorRecommender
    from code.models.response_generator import ResponseGenerator
    from code.models.conversation_manager import ConversationManager
...
async def analyze_symptoms(request: SymptomRequest):
    ...
    try:
        ...
        risk_result = risk_classifier.classify(extracted, context_text="")
...
async def list_symptoms():
    ...
    from dataset.symptoms_db import SYMPTOM_KEYWORDS, SPECIALIST_MAP, RISK_LEVELS
