...
from data.symptoms_db import SYMPTOM_KEYWORDS, SYMPTOM_DESCRIPTIONS
...
class BERTSymptomAnalyzer:
    ...
    def _bert_semantic_match(self, text: str, threshold: float = 0.93) -> Dict[str, float]:
        """BERT-based semantic similarity matching.
        
        Threshold raised to 0.93 because BioBERT embeddings in the medical
        domain share high baseline cosine similarity (~0.85-0.90). A lower
        threshold causes nearly every symptom to match any medical input.
        """
    ...
    def analyze(self, user_input: str) -> Dict:
        ...
        for symptom in all_symptoms:
            ...
            if kw_score > 0 and bert_score > 0:
                ...
                # Heavy discount for BERT-only matches to strongly reduce false positives
                combined_score = bert_score * 0.55
